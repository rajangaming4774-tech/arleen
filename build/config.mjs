...
const clips = 5;        // raw clips in raw/tour/, in order: 0 (title-card take) + chapters 1–4
...
export const TOUR = {
  ...
  clipSeconds,
  xfade,
  seconds: clips * clipSeconds - (clips - 1) * xfade, // length of the stitched master (37.6s)
