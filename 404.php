...
<section class="cover">
  <div class="container cover__grid">
    <div class="cover__text">
      ...
      <h1 class="display reveal">Page <em>not found</em></h1>
      <p class="lead reveal">Sorry, we could not find that page. Try one of the divisions below.</p>
      
    </div>
    <figure class="cover__media reveal">
      <img class="cover__img" src="/assets/img/hero-home.webp" srcset="/assets/img/hero-home-sm.webp 800w, /assets/img/hero-home.webp 1920w" sizes="(max-width: 900px) 100vw, 58vw" alt="Arleen Builders project" width="1920" height="1280" fetchpriority="high">
...
<section class="section section--flush"><div class="container"><div class="rows rows--columns"><article class="row reveal">
