...
<div class="menu" id="menu" aria-label="Site menu">
  <nav class="menu__links" aria-label="Pages">
        ...
        <a href="/services.php" aria-current="page"><span>04</span>Services</a>
...
<section class="page-hero">
  <img class="page-hero__bg" src="/assets/img/hero-construction.webp" srcset="/assets/img/hero-construction-sm.webp 800w, /assets/img/hero-construction.webp 1920w" sizes="100vw" alt="Residential apartment building constructed by Arleen Builders in Chennai" width="1920" height="1280" fetchpriority="high">
  <div class="container">
    ...
    <h1 class="display reveal">Construction &amp; interior services in Chennai</h1>
