...
<link rel="preload" as="image" href="/assets/img/hero-home.webp" imagesrcset="/assets/img/hero-home-sm.webp 800w, /assets/img/hero-home.webp 1280w" imagesizes="(max-width: 900px) 100vw, 58vw">
...
<section class="cover">
  <div class="container cover__grid">
    ...
    <figure class="cover__media reveal">
      <img class="cover__img" src="/assets/img/hero-home.webp" srcset="/assets/img/hero-home-sm.webp 800w, /assets/img/hero-home.webp 1280w" sizes="(max-width: 900px) 100vw, 58vw" alt="Commercial building by Arleen Builders, Chennai" width="1280" height="853" fetchpriority="high">
